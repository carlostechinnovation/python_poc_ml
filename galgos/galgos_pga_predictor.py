...
def leerFeaturesDelCasoAPredecirDesdeBaseDatos():
    ...
    c.execute('SELECT * from datos_desa.tb_pga_score_FEATURES_pre;')  # Mismas features que PRE, en este caso
    alist = c.fetchall()
...
mejor_modelo = joblib.load(
    '/home/carloslinux/Desktop/WORKSPACES/wksp_pycharm/python_poc_ml/galgos/pga_MEJOR_MODELO.pkl')
...
##############################################
fichero_resultados = open('/home/carloslinux/Desktop/DATOS_LIMPIO/galgos/pga_target_post.txt', 'w')
